...
\usepackage{ulem} % Subrayar palabras
...
Por contribuir a hacer de cada día una historia inolvidable} % Como mucho dos líneas (no confundir con los agradecimientos).
%---
%
% FIN PORTADAS: 
% |
...
\include{./caps/EstadoArte}
\include{./caps/Desarrollo}
\include{./caps/ImpactoMedioAmbiente}
